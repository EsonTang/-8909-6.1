...
public class DeviceProfile {
    ...
    DeviceProfile(Context context,
        ...
        if (res.getBoolean(R.bool.config_jio_new_feature_enabled)) {
            allAppsIconSizePx = DynamicGrid.pxFromDp(res.
                    getInteger(R.integer.config_jio_allapp_icon_size), dm);
            iconTextSize = res.getInteger(R.integer.config_jio_icon_text_size);
        }
        ...
        // Search Bar
        if (res.getBoolean(R.bool.config_jio_new_feature_enabled)) {
            SettingsProvider.putBoolean(context, SettingsProvider.SETTINGS_UI_HOMESCREEN_SEARCH,
                    false);
        }
