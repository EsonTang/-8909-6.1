...
public class NotesList extends Activity implements ConstInterfaceNotesList {
    ...
    private TextView mEmptySloganTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // created.
        UpdateAdapterData();
        mEmptySloganTextView = (TextView) findViewById(R.id.emptySloganTextView);
        mEmptySloganTextView.setTypeface(Typeface.SANS_SERIF);
        mAddButton = (ImageView) findViewById(R.id.add_note);
            ...
            Spinner.OnItemSelectedListener, SpinnerAdapter
    {
        ...
        private String getSelectTitle() {
            ...
            String title = NotesList.this.getString(R.string.menu_delete_selected);
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            getWindow().setStatusBarColor(getResources().getColor(R.color.selectedStatusBarColorCode));
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            getWindow().setStatusBarColor(getResources().getColor(R.color.statusBarColorCode));
            exitMultiSelectView();
        }
        ...
        public void onItemCheckedStateChanged(ActionMode mode, int position,
            ...
            setDeleteMenuItemVisibility(mode, true);
            Uri uri = ContentUris.withAppendedId(getIntent().getData(), id);
    ...
    private void setDeleteMenuItemVisibility(ActionMode mode, boolean visibility) {
        Menu menu = mode.getMenu();
        MenuItem menu_delete = menu.findItem(R.id.delete);
        menu_delete.setVisible(visibility);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
                ...
                try {
                    ...
                    setDeleteMenuItemVisibility(am, false);
        ...
        new AlertDialog.Builder(mContext)
                ...
                .setMessage(
                        getString(R.string.msg_all) + " ("
                                + mListView.getCount() + ") "
                                + getString(R.string.confirm_delete_notes))
    ...
    private void confirmDeleteMultiActionMode() {
        ...
        String msg = "";
        if (listCnt > 1) {
            msg = getString(R.string.confirm_delete_notes);
        } else {
            msg = getString(R.string.confirm_delete_notes_single);
        }
        new AlertDialog.Builder(this)
                .setTitle(R.string.menu_delete)
                .setMessage(listCnt + " " + msg)
                .setNegativeButton(android.R.string.cancel, null)
    ...
    private void setListViewBk(boolean state, int position) {
        ...
        if (state == false) {
            ...
            if (mListView.isItemChecked(position)) {
                View view = mListView.getChildAt(position-topIndex);
                if(view!=null)
                    view.setBackgroundColor(getResources().getColor(R.color.actionModeTitleBarColor));
